...
# Add [SIL] token to the dictionary
...
class Dictionary:
    ...
    def __init__(
        ...
        *,  # begin keyword-only arguments
        ...
        self.sil_index = self.add_symbol(sil)
    ...
    def add_from_file(self, f):
        ...
        lines = f.readlines()
        indices_start_line = self._load_meta(lines) # return 0
...
#     dictionary = Dictionary.load('/raid/hpc/gemeng/se_asr/pretrain_data/hubert_data/dict.km.txt')
#     print(dictionary.symbols)
#     print(dictionary.nspecial)
